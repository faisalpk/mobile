            ...
            <View style={{flexDirection: 'column', width: '100%'}}>
              <ScrollView
                ...
                <View
                  ...
                  Stress and uncertainty can lead to changes in the way we operate but particularly in the way we eat. Eating and making food choice is such a subconscious process that we most often don’t even realise the choices we are making. 
                  </Text>
                </View>
                <View
                    style={{
            ...
            <View style={{flexDirection: 'column', width: '100%'}}>
              <ScrollView
                ...
                <View
                  ...
                  />
                  <Text style={{alignContent: 'flex-end'}}>
                  When we feel stressed and overwhelmed the last thing we want to think about is eating healthy and thinking about our diet. But rather than thinking of food as something to make us worried and stressed we can think of it as something that fuels our bodies and keeps our brains nourished.
                  </Text>
                </View>
                <View
                    style={{
            ...
            <View style={{flexDirection: 'column', width: '100%'}}>
              <ScrollView
                ...
                <View
                  ...
                  />
                  <Text style={{alignContent: 'flex-end'}}>
                  When you are in chronic stressed state our body can respond by setting off small alarms within our body’s functions and systems to let us know it is in distress
                  </Text>
                </View>
                <View
                    style={{
